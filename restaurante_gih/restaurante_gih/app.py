...
restaurantes = [
    {'nome': 'Aroma da Terra', 'categoria': 'gastronomia saudável e sustentável', 'ativo': True},
    {'nome': 'Cantinho do Sabor Caseiro', 'categoria': 'feijoada', 'ativo': False},
    {'nome': 'Bistro da Saborosa', 'categoria': ' culinária contemporânea', 'ativo': True}
]
